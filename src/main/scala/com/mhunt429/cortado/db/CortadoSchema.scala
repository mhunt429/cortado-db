...
trait CortadoSchema {
   ...
   *  @param accessType Database column access_type SqlType(varchar), Length(40,true)
   *  @param accessDate Database column access_date SqlType(timestamptz)
  ...
  case class AccessLogRow(originalInsert: java.time.Instant, lastUpdate: java.time.Instant, appLastChangedBy: Int, id: Int, userId: Int, accessType: String, accessDate: java.time.Instant, ipAddress: Option[String] = None, userAgent: Option[String] = None, success: Boolean)
  /** GetResult implicit for fetching AccessLogRow objects using plain SQL queries */
  implicit def GetResultAccessLogRow(implicit e0: GR[java.time.Instant], e1: GR[Int], e2: GR[String], e3: GR[Option[String]], e4: GR[Boolean]): GR[AccessLogRow] = GR{
    prs => import prs._
  ...
  class AccessLog(_tableTag: Tag) extends profile.api.Table[AccessLogRow](_tableTag, "access_log") {
    ...
    def ? = ((Rep.Some(originalInsert), Rep.Some(lastUpdate), Rep.Some(appLastChangedBy), Rep.Some(id), Rep.Some(userId), Rep.Some(accessType), Rep.Some(accessDate), ipAddress, userAgent, Rep.Some(success))).shaped.<>({r=>import r._; _1.map(_=> (AccessLogRow.apply _).tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7.get, _8, _9, _10.get)))}, (_:Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column access_type SqlType(varchar), Length(40,true) */
    val accessType: Rep[String] = column[String]("access_type", O.Length(40,varying=true))
    /** Database column access_date SqlType(timestamptz) */
    val accessDate: Rep[java.time.Instant] = column[java.time.Instant]("access_date")
    ...
    lazy val appUserFk = foreignKey("access_log_user_id_fkey", userId, AppUser)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.SetNull)
  }
   ...
   *  @param id Database column id SqlType(serial), AutoInc, PrimaryKey
   *  @param userId Database column user_id SqlType(int4)
   *  @param financialAccountId Database column financial_account_id SqlType(int4)
   *  @param currentBalance Database column current_balance SqlType(numeric)
   *  @param availableBalance Database column available_balance SqlType(numeric)
   *  @param createdAt Database column created_at SqlType(timestamptz) */
  case class AccountBalanceHistoryRow(originalInsert: java.time.Instant, lastUpdate: java.time.Instant, appLastChangedBy: Int, id: Int, userId: Int, financialAccountId: Int, currentBalance: scala.math.BigDecimal, availableBalance: scala.math.BigDecimal, createdAt: java.time.Instant)
  /** GetResult implicit for fetching AccountBalanceHistoryRow objects using plain SQL queries */
  implicit def GetResultAccountBalanceHistoryRow(implicit e0: GR[java.time.Instant], e1: GR[Int], e2: GR[scala.math.BigDecimal]): GR[AccountBalanceHistoryRow] = GR{
    prs => import prs._
  ...
  class AccountBalanceHistory(_tableTag: Tag) extends profile.api.Table[AccountBalanceHistoryRow](_tableTag, "account_balance_history") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(originalInsert), Rep.Some(lastUpdate), Rep.Some(appLastChangedBy), Rep.Some(id), Rep.Some(userId), Rep.Some(financialAccountId), Rep.Some(currentBalance), Rep.Some(availableBalance), Rep.Some(createdAt))).shaped.<>({r=>import r._; _1.map(_=> (AccountBalanceHistoryRow.apply _).tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7.get, _8.get, _9.get)))}, (_:Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column user_id SqlType(int4) */
    val userId: Rep[Int] = column[Int]("user_id")
    /** Database column financial_account_id SqlType(int4) */
    val financialAccountId: Rep[Int] = column[Int]("financial_account_id")
    /** Database column current_balance SqlType(numeric) */
    val currentBalance: Rep[scala.math.BigDecimal] = column[scala.math.BigDecimal]("current_balance")
    /** Database column available_balance SqlType(numeric) */
    val availableBalance: Rep[scala.math.BigDecimal] = column[scala.math.BigDecimal]("available_balance")
    ...
    lazy val appUserFk = foreignKey("account_balance_history_user_id_fkey", userId, AppUser)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.SetNull)
    /** Foreign key referencing FinancialAccount (database name account_balance_history_financial_account_id_fkey) */
    lazy val financialAccountFk = foreignKey("account_balance_history_financial_account_id_fkey", financialAccountId, FinancialAccount)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.SetNull)
  }
   ...
   *  @param institutionId Database column institution_id SqlType(text), Default()
   *  @param institutionName Database column institution_name SqlType(text), Default()
   *  @param dateConnected Database column date_connected SqlType(timestamptz)
   *  @param encryptedAccessToken Database column encrypted_access_token SqlType(bytea)
   *  @param transactionSyncCursor Database column transaction_sync_cursor SqlType(text), Default(None)
   *  @param externalId Database column external_id SqlType(text), Default()
  ...
  case class AccountConnectorRow(originalInsert: java.time.Instant, lastUpdate: java.time.Instant, appLastChangedBy: Int, id: Int, userId: Option[Int] = None, institutionId: String = "", institutionName: String = "", dateConnected: java.time.Instant, encryptedAccessToken: Array[Byte], transactionSyncCursor: Option[String] = None, externalId: String = "", disconnectedTs: Option[java.time.Instant] = None, requiresReauthentication: Option[Boolean] = Some(false), lastSyncDate: Option[java.time.Instant] = None, nextSyncDate: Option[java.time.Instant] = None)
  /** GetResult implicit for fetching AccountConnectorRow objects using plain SQL queries */
  implicit def GetResultAccountConnectorRow(implicit e0: GR[java.time.Instant], e1: GR[Int], e2: GR[Option[Int]], e3: GR[String], e4: GR[Array[Byte]], e5: GR[Option[String]], e6: GR[Option[java.time.Instant]], e7: GR[Option[Boolean]]): GR[AccountConnectorRow] = GR{
    prs => import prs._
  ...
  class AccountConnector(_tableTag: Tag) extends profile.api.Table[AccountConnectorRow](_tableTag, "account_connector") {
    def * = ((originalInsert, lastUpdate, appLastChangedBy, id, userId, institutionId, institutionName, dateConnected, encryptedAccessToken, transactionSyncCursor, externalId, disconnectedTs, requiresReauthentication, lastSyncDate, nextSyncDate)).mapTo[AccountConnectorRow]
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(originalInsert), Rep.Some(lastUpdate), Rep.Some(appLastChangedBy), Rep.Some(id), userId, Rep.Some(institutionId), Rep.Some(institutionName), Rep.Some(dateConnected), Rep.Some(encryptedAccessToken), transactionSyncCursor, Rep.Some(externalId), disconnectedTs, requiresReauthentication, lastSyncDate, nextSyncDate)).shaped.<>({r=>import r._; _1.map(_=> (AccountConnectorRow.apply _).tupled((_1.get, _2.get, _3.get, _4.get, _5, _6.get, _7.get, _8.get, _9.get, _10, _11.get, _12, _13, _14, _15)))}, (_:Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column institution_id SqlType(text), Default() */
    val institutionId: Rep[String] = column[String]("institution_id", O.Default(""))
    /** Database column institution_name SqlType(text), Default() */
    val institutionName: Rep[String] = column[String]("institution_name", O.Default(""))
    /** Database column date_connected SqlType(timestamptz) */
    val dateConnected: Rep[java.time.Instant] = column[java.time.Instant]("date_connected")
    /** Database column encrypted_access_token SqlType(bytea) */
    val encryptedAccessToken: Rep[Array[Byte]] = column[Array[Byte]]("encrypted_access_token")
    ...
    /** Database column external_id SqlType(text), Default() */
    val externalId: Rep[String] = column[String]("external_id", O.Default(""))
   ...
   *  @param createdDate Database column created_date SqlType(timestamptz)
   *  @param encryptedEmail Database column encrypted_email SqlType(bytea)
   *  @param password Database column password SqlType(text)
   *  @param encryptedName Database column encrypted_name SqlType(bytea)
   *  @param encryptedPhone Database column encrypted_phone SqlType(bytea)
   ...
   *  @param phoneVerified Database column phone_verified SqlType(bool), Default(false)
   *  @param emailVerified Database column email_verified SqlType(bool), Default(false)
   *  @param emailHash Database column email_hash SqlType(varchar), Length(64,true) */
  case class AppUserRow(originalInsert: java.time.Instant, lastUpdate: java.time.Instant, appLastChangedBy: Int, id: Int, accountId: Int, createdDate: java.time.Instant, encryptedEmail: Array[Byte], password: String, encryptedName: Array[Byte], encryptedPhone: Array[Byte], lastLoginDate: Option[java.time.Instant] = None, lastLoginIp: Option[String] = None, phoneVerified: Boolean = false, emailVerified: Boolean = false, emailHash: String)
  /** GetResult implicit for fetching AppUserRow objects using plain SQL queries */
  implicit def GetResultAppUserRow(implicit e0: GR[java.time.Instant], e1: GR[Int], e2: GR[Array[Byte]], e3: GR[String], e4: GR[Option[java.time.Instant]], e5: GR[Option[String]], e6: GR[Boolean]): GR[AppUserRow] = GR{
    prs => import prs._
  ...
  class AppUser(_tableTag: Tag) extends profile.api.Table[AppUserRow](_tableTag, "app_user") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(originalInsert), Rep.Some(lastUpdate), Rep.Some(appLastChangedBy), Rep.Some(id), Rep.Some(accountId), Rep.Some(createdDate), Rep.Some(encryptedEmail), Rep.Some(password), Rep.Some(encryptedName), Rep.Some(encryptedPhone), lastLoginDate, lastLoginIp, Rep.Some(phoneVerified), Rep.Some(emailVerified), Rep.Some(emailHash))).shaped.<>({r=>import r._; _1.map(_=> (AppUserRow.apply _).tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7.get, _8.get, _9.get, _10.get, _11, _12, _13.get, _14.get, _15.get)))}, (_:Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column created_date SqlType(timestamptz) */
    val createdDate: Rep[java.time.Instant] = column[java.time.Instant]("created_date")
    /** Database column encrypted_email SqlType(bytea) */
    val encryptedEmail: Rep[Array[Byte]] = column[Array[Byte]]("encrypted_email")
    /** Database column password SqlType(text) */
    val password: Rep[String] = column[String]("password")
    /** Database column encrypted_name SqlType(bytea) */
    val encryptedName: Rep[Array[Byte]] = column[Array[Byte]]("encrypted_name")
    /** Database column encrypted_phone SqlType(bytea) */
    val encryptedPhone: Rep[Array[Byte]] = column[Array[Byte]]("encrypted_phone")
    ...
    /** Database column phone_verified SqlType(bool), Default(false) */
    val phoneVerified: Rep[Boolean] = column[Boolean]("phone_verified", O.Default(false))
    ...
    /** Database column email_hash SqlType(varchar), Length(64,true) */
    val emailHash: Rep[String] = column[String]("email_hash", O.Length(64,varying=true))

    /** Foreign key referencing UserAccount (database name app_user_account_id_fkey) */
    lazy val userAccountFk = foreignKey("app_user_account_id_fkey", accountId, UserAccount)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.SetNull)

    /** Uniqueness Index over (emailHash) (database name app_user_email_hash_key) */
    val index1 = index("app_user_email_hash_key", emailHash, unique=true)
    /** Index over (emailHash) (database name au_email_hash_indx) */
    val index2 = index("au_email_hash_indx", emailHash)
  }
   ...
   *  @param id Database column id SqlType(serial), AutoInc, PrimaryKey
   *  @param userId Database column user_id SqlType(int4)
   *  @param syncType Database column sync_type SqlType(varchar), Length(40,true)
   *  @param lastSyncDate Database column last_sync_date SqlType(timestamptz)
   *  @param nextSyncDate Database column next_sync_date SqlType(timestamptz)
   *  @param connectorId Database column connector_id SqlType(int4) */
  case class ConnectionSyncDataRow(originalInsert: java.time.Instant, lastUpdate: java.time.Instant, appLastChangedBy: Int, id: Int, userId: Int, syncType: String, lastSyncDate: java.time.Instant, nextSyncDate: java.time.Instant, connectorId: Int)
  /** GetResult implicit for fetching ConnectionSyncDataRow objects using plain SQL queries */
  implicit def GetResultConnectionSyncDataRow(implicit e0: GR[java.time.Instant], e1: GR[Int], e2: GR[String]): GR[ConnectionSyncDataRow] = GR{
    prs => import prs._
  ...
  class ConnectionSyncData(_tableTag: Tag) extends profile.api.Table[ConnectionSyncDataRow](_tableTag, "connection_sync_data") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(originalInsert), Rep.Some(lastUpdate), Rep.Some(appLastChangedBy), Rep.Some(id), Rep.Some(userId), Rep.Some(syncType), Rep.Some(lastSyncDate), Rep.Some(nextSyncDate), Rep.Some(connectorId))).shaped.<>({r=>import r._; _1.map(_=> (ConnectionSyncDataRow.apply _).tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7.get, _8.get, _9.get)))}, (_:Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column user_id SqlType(int4) */
    val userId: Rep[Int] = column[Int]("user_id")
    /** Database column sync_type SqlType(varchar), Length(40,true) */
    val syncType: Rep[String] = column[String]("sync_type", O.Length(40,varying=true))
    /** Database column last_sync_date SqlType(timestamptz) */
    val lastSyncDate: Rep[java.time.Instant] = column[java.time.Instant]("last_sync_date")
    /** Database column next_sync_date SqlType(timestamptz) */
    val nextSyncDate: Rep[java.time.Instant] = column[java.time.Instant]("next_sync_date")
    /** Database column connector_id SqlType(int4) */
    val connectorId: Rep[Int] = column[Int]("connector_id")

    /** Foreign key referencing AccountConnector (database name connection_sync_data_connector_id_fkey) */
    lazy val accountConnectorFk = foreignKey("connection_sync_data_connector_id_fkey", connectorId, AccountConnector)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.SetNull)
    /** Foreign key referencing AppUser (database name connection_sync_data_user_id_fkey) */
    lazy val appUserFk = foreignKey("connection_sync_data_user_id_fkey", userId, AppUser)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
  }
   ...
   *  @param currentBalance Database column current_balance SqlType(numeric)
   *  @param availableBalance Database column available_balance SqlType(numeric)
   *  @param accountMask Database column account_mask SqlType(varchar), Length(16,true)
   ...
   *  @param subtype Database column subtype SqlType(text)
   *  @param isExternalApiImport Database column is_external_api_import SqlType(bool), Default(false)
   *  @param lastApiSyncTime Database column last_api_sync_time SqlType(timestamptz), Default(None) */
  case class FinancialAccountRow(originalInsert: java.time.Instant, lastUpdate: java.time.Instant, appLastChangedBy: Int, id: Int, userId: Option[Int] = None, connectorId: Option[Int] = None, externalId: Option[String] = None, currentBalance: scala.math.BigDecimal, availableBalance: scala.math.BigDecimal, accountMask: String, displayName: String, officialName: Option[String] = None, subtype: String, isExternalApiImport: Boolean = false, lastApiSyncTime: Option[java.time.Instant] = None)
  /** GetResult implicit for fetching FinancialAccountRow objects using plain SQL queries */
  implicit def GetResultFinancialAccountRow(implicit e0: GR[java.time.Instant], e1: GR[Int], e2: GR[Option[Int]], e3: GR[Option[String]], e4: GR[scala.math.BigDecimal], e5: GR[String], e6: GR[Boolean], e7: GR[Option[java.time.Instant]]): GR[FinancialAccountRow] = GR{
    prs => import prs._
  ...
  class FinancialAccount(_tableTag: Tag) extends profile.api.Table[FinancialAccountRow](_tableTag, "financial_account") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(originalInsert), Rep.Some(lastUpdate), Rep.Some(appLastChangedBy), Rep.Some(id), userId, connectorId, externalId, Rep.Some(currentBalance), Rep.Some(availableBalance), Rep.Some(accountMask), Rep.Some(displayName), officialName, Rep.Some(subtype), Rep.Some(isExternalApiImport), lastApiSyncTime)).shaped.<>({r=>import r._; _1.map(_=> (FinancialAccountRow.apply _).tupled((_1.get, _2.get, _3.get, _4.get, _5, _6, _7, _8.get, _9.get, _10.get, _11.get, _12, _13.get, _14.get, _15)))}, (_:Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column available_balance SqlType(numeric) */
    val availableBalance: Rep[scala.math.BigDecimal] = column[scala.math.BigDecimal]("available_balance")
    /** Database column account_mask SqlType(varchar), Length(16,true) */
    val accountMask: Rep[String] = column[String]("account_mask", O.Length(16,varying=true))
    ...
    /** Database column subtype SqlType(text) */
    val subtype: Rep[String] = column[String]("subtype")
    /** Database column is_external_api_import SqlType(bool), Default(false) */
    val isExternalApiImport: Rep[Boolean] = column[Boolean]("is_external_api_import", O.Default(false))
   ...
   *  @param accountId Database column account_id SqlType(int4)
   *  @param externalId Database column external_id SqlType(text), Default(None)
   *  @param primaryDescription Database column primary_description SqlType(text), Default()
   *  @param detailedDescription Database column detailed_description SqlType(text), Default()
   ...
   *  @param frequency Database column frequency SqlType(varchar), Length(30,true) */
  case class RecurringTransactionRow(originalInsert: java.time.Instant, lastUpdate: java.time.Instant, appLastChangedBy: Int, id: Int, userId: Int, accountId: Int, externalId: Option[String] = None, primaryDescription: String = "", detailedDescription: String = "", categoryId: Int, averageAmount: Option[scala.math.BigDecimal] = None, lastAmount: Option[scala.math.BigDecimal] = None, firstDate: Option[java.time.Instant] = None, lastDate: Option[java.time.Instant] = None, predictedNextDate: Option[java.time.Instant] = None, frequency: String)
  /** GetResult implicit for fetching RecurringTransactionRow objects using plain SQL queries */
  implicit def GetResultRecurringTransactionRow(implicit e0: GR[java.time.Instant], e1: GR[Int], e2: GR[Option[String]], e3: GR[String], e4: GR[Option[scala.math.BigDecimal]], e5: GR[Option[java.time.Instant]]): GR[RecurringTransactionRow] = GR{
    prs => import prs._
  ...
  class RecurringTransaction(_tableTag: Tag) extends profile.api.Table[RecurringTransactionRow](_tableTag, "recurring_transaction") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(originalInsert), Rep.Some(lastUpdate), Rep.Some(appLastChangedBy), Rep.Some(id), Rep.Some(userId), Rep.Some(accountId), externalId, Rep.Some(primaryDescription), Rep.Some(detailedDescription), Rep.Some(categoryId), averageAmount, lastAmount, firstDate, lastDate, predictedNextDate, Rep.Some(frequency))).shaped.<>({r=>import r._; _1.map(_=> (RecurringTransactionRow.apply _).tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7, _8.get, _9.get, _10.get, _11, _12, _13, _14, _15, _16.get)))}, (_:Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column external_id SqlType(text), Default(None) */
    val externalId: Rep[Option[String]] = column[Option[String]]("external_id", O.Default(None))
    /** Database column primary_description SqlType(text), Default() */
    val primaryDescription: Rep[String] = column[String]("primary_description", O.Default(""))
    /** Database column detailed_description SqlType(text), Default() */
    val detailedDescription: Rep[String] = column[String]("detailed_description", O.Default(""))
    ...
    /** Database column frequency SqlType(varchar), Length(30,true) */
    val frequency: Rep[String] = column[String]("frequency", O.Length(30,varying=true))
    ...
    lazy val userTransactionCategoryFk = foreignKey("recurring_transaction_category_id_fkey", categoryId, UserTransactionCategory)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.Cascade)
   ...
   *  @param tokenType Database column token_type SqlType(varchar), Length(20,true)
   *  @param createdAt Database column created_at SqlType(timestamptz)
   *  @param expiresAt Database column expires_at SqlType(timestamptz) */
  case class TokenRow(originalInsert: java.time.Instant, lastUpdate: java.time.Instant, appLastChangedBy: Int, id: Int, userId: Int, token: String, tokenType: String, createdAt: java.time.Instant, expiresAt: java.time.Instant)
  /** GetResult implicit for fetching TokenRow objects using plain SQL queries */
  implicit def GetResultTokenRow(implicit e0: GR[java.time.Instant], e1: GR[Int], e2: GR[String]): GR[TokenRow] = GR{
    prs => import prs._
  ...
  class Token(_tableTag: Tag) extends profile.api.Table[TokenRow](_tableTag, "token") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(originalInsert), Rep.Some(lastUpdate), Rep.Some(appLastChangedBy), Rep.Some(id), Rep.Some(userId), Rep.Some(token), Rep.Some(tokenType), Rep.Some(createdAt), Rep.Some(expiresAt))).shaped.<>({r=>import r._; _1.map(_=> (TokenRow.apply _).tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7.get, _8.get, _9.get)))}, (_:Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column token_type SqlType(varchar), Length(20,true) */
    val tokenType: Rep[String] = column[String]("token_type", O.Length(20,varying=true))
    /** Database column created_at SqlType(timestamptz) */
    val createdAt: Rep[java.time.Instant] = column[java.time.Instant]("created_at")
    /** Database column expires_at SqlType(timestamptz) */
    val expiresAt: Rep[java.time.Instant] = column[java.time.Instant]("expires_at")

    /** Foreign key referencing AppUser (database name token_user_id_fkey) */
    lazy val appUserFk = foreignKey("token_user_id_fkey", userId, AppUser)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.SetNull)
   ...
   *  @param pending Database column pending SqlType(bool), Default(false)
   *  @param accountId Database column account_id SqlType(int4)
   *  @param merchantName Database column merchant_name SqlType(varchar), Length(100,true)
  ...
  case class TransactionRow(originalInsert: java.time.Instant, lastUpdate: java.time.Instant, appLastChangedBy: Int, id: Int, userId: Int, amount: scala.math.BigDecimal, transactionDate: java.time.Instant, importedDate: Option[java.time.Instant] = None, pending: Boolean = false, accountId: Int, merchantName: String, transactionName: Option[String] = None, externalTransactionId: Option[String] = None, merchantLogoUrl: Option[String] = None, recurringTransactionId: Option[Int] = None)
  /** GetResult implicit for fetching TransactionRow objects using plain SQL queries */
  implicit def GetResultTransactionRow(implicit e0: GR[java.time.Instant], e1: GR[Int], e2: GR[scala.math.BigDecimal], e3: GR[Option[java.time.Instant]], e4: GR[Boolean], e5: GR[String], e6: GR[Option[String]], e7: GR[Option[Int]]): GR[TransactionRow] = GR{
    prs => import prs._
  ...
  class Transaction(_tableTag: Tag) extends profile.api.Table[TransactionRow](_tableTag, "transaction") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(originalInsert), Rep.Some(lastUpdate), Rep.Some(appLastChangedBy), Rep.Some(id), Rep.Some(userId), Rep.Some(amount), Rep.Some(transactionDate), importedDate, Rep.Some(pending), Rep.Some(accountId), Rep.Some(merchantName), transactionName, externalTransactionId, merchantLogoUrl, recurringTransactionId)).shaped.<>({r=>import r._; _1.map(_=> (TransactionRow.apply _).tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7.get, _8, _9.get, _10.get, _11.get, _12, _13, _14, _15)))}, (_:Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column pending SqlType(bool), Default(false) */
    val pending: Rep[Boolean] = column[Boolean]("pending", O.Default(false))
    /** Database column account_id SqlType(int4) */
    val accountId: Rep[Int] = column[Int]("account_id")
    /** Database column merchant_name SqlType(varchar), Length(100,true) */
    val merchantName: Rep[String] = column[String]("merchant_name", O.Length(100,varying=true))
  ...
  case class UserAccountRow(originalInsert: java.time.Instant, lastUpdate: java.time.Instant, appLastChangedBy: Int, id: Int, createdOn: java.time.Instant, accountName: Option[String] = None)
  /** GetResult implicit for fetching UserAccountRow objects using plain SQL queries */
  implicit def GetResultUserAccountRow(implicit e0: GR[java.time.Instant], e1: GR[Int], e2: GR[Option[String]]): GR[UserAccountRow] = GR{
    prs => import prs._
  ...
  class UserAccount(_tableTag: Tag) extends profile.api.Table[UserAccountRow](_tableTag, "user_account") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(originalInsert), Rep.Some(lastUpdate), Rep.Some(appLastChangedBy), Rep.Some(id), Rep.Some(createdOn), accountName)).shaped.<>({r=>import r._; _1.map(_=> (UserAccountRow.apply _).tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6)))}, (_:Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val createdOn: Rep[java.time.Instant] = column[java.time.Instant]("created_on")
   ...
   *  @param userId Database column user_id SqlType(int4)
   *  @param hasSeen Database column has_seen SqlType(bool), Default(false)
  ...
  case class UserMailboxRow(originalInsert: java.time.Instant, lastUpdate: java.time.Instant, appLastChangedBy: Int, id: Int, messageKey: String, userId: Int, hasSeen: Boolean = false, messageBody: String, subject: String)
  ...
  implicit def GetResultUserMailboxRow(implicit e0: GR[java.time.Instant], e1: GR[Int], e2: GR[String], e3: GR[Boolean]): GR[UserMailboxRow] = GR{
    prs => import prs._
    (UserMailboxRow.apply _).tupled((<<[java.time.Instant], <<[java.time.Instant], <<[Int], <<[Int], <<[String], <<[Int], <<[Boolean], <<[String], <<[String]))
  }
  ...
  class UserMailbox(_tableTag: Tag) extends profile.api.Table[UserMailboxRow](_tableTag, "user_mailbox") {
    def * = ((originalInsert, lastUpdate, appLastChangedBy, id, messageKey, userId, hasSeen, messageBody, subject)).mapTo[UserMailboxRow]
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(originalInsert), Rep.Some(lastUpdate), Rep.Some(appLastChangedBy), Rep.Some(id), Rep.Some(messageKey), Rep.Some(userId), Rep.Some(hasSeen), Rep.Some(messageBody), Rep.Some(subject))).shaped.<>({r=>import r._; _1.map(_=> (UserMailboxRow.apply _).tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7.get, _8.get, _9.get)))}, (_:Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column user_id SqlType(int4) */
    val userId: Rep[Int] = column[Int]("user_id")
    /** Database column has_seen SqlType(bool), Default(false) */
    val hasSeen: Rep[Boolean] = column[Boolean]("has_seen", O.Default(false))
   ...
   *  @param expiresAt Database column expires_at SqlType(timestamptz) */
  case class UserSessionRow(originalInsert: java.time.Instant, lastUpdate: java.time.Instant, appLastChangedBy: Int, id: java.util.UUID, userId: Int, issuedAt: java.time.Instant, expiresAt: java.time.Instant)
  /** GetResult implicit for fetching UserSessionRow objects using plain SQL queries */
  implicit def GetResultUserSessionRow(implicit e0: GR[java.time.Instant], e1: GR[Int], e2: GR[java.util.UUID]): GR[UserSessionRow] = GR{
    prs => import prs._
  ...
  class UserSession(_tableTag: Tag) extends profile.api.Table[UserSessionRow](_tableTag, "user_session") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(originalInsert), Rep.Some(lastUpdate), Rep.Some(appLastChangedBy), Rep.Some(id), Rep.Some(userId), Rep.Some(issuedAt), Rep.Some(expiresAt))).shaped.<>({r=>import r._; _1.map(_=> (UserSessionRow.apply _).tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7.get)))}, (_:Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val issuedAt: Rep[java.time.Instant] = column[java.time.Instant]("issued_at")
    /** Database column expires_at SqlType(timestamptz) */
    val expiresAt: Rep[java.time.Instant] = column[java.time.Instant]("expires_at")

    /** Foreign key referencing AppUser (database name user_session_user_id_fkey) */
    lazy val appUserFk = foreignKey("user_session_user_id_fkey", userId, AppUser)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.SetNull)
  }
